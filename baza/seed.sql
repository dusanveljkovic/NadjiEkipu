...
('jana', 'jana@nadjiekipu.com', SHA2('password123', 256), 'Jana', 'jana', 2004, 3, 3);


INSERT INTO `users` (`username`, `email`, `password_hash`, `firstname`, `lastname`, `birthyear`, `role_id`, `avatar_id`) VALUES 
('tigar', 'tigar@nadjiekipu.com', SHA2('password123', 256), 'Tigar', 'Tigric', 2004, 2, 2);
COMMIT;
UPDATE `users` SET `lastname` = '' WHERE `username` = 'jana';
...
(8, 2, 'Planinarenje na Avali', 'Dnevni planinarski pohod na Avali', DATE_ADD(NOW(), INTERVAL 14 DAY), 44.786568, 20.448922, 'Avala - pocetak staze', 12, 0),
...
-- =============================================
INSERT INTO `moderator_requests` (`user_id`, `status`, `created_at`, `resolved_at`) VALUES 
(4, 'PENDING', NOW(), NULL),
